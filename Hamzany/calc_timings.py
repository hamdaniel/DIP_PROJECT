...
encode_file = '../datasets/BSD500_timings/encode_timings_cpu.csv'
decode_file = '../datasets/BSD500_timings/decode_timings_cpu.csv'
output_file = '../datasets/BSD500_timings/timings_cpu.csv'
